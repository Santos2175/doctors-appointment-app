...
const VerificationPage = async () => {
  ...
  // If user is already verified, redirect to '/doctor'
      ...
      <div className='max-w-2xl mx-auto'>
        <Card className='border-emerald-900/20'>
          <CardHeader className='text-center'>
            ...
            <CardDescription className='text-lb'>
              {isRejected
          ...
          <CardContent>
            {isRejected ? (
              <div className='bg-red-900/10 border border-red-900/20 rounded-lg p-4 mb-6 flex items-start'>
                ...
                <div className='text-muted-foreground text-left'>
                  <p className='mb-2'>
                    ...
                    found that it does&apos; meet our current requirements.
                    Common reason for rejection includes:
                  </p>
                  <ul className='list-disc pl-5 space-y-1 mb-3'>
                    <li>Insufficient or unclear credential documentation</li>
                    <li>Professional experiences not met</li>
              ...
              <div className='bg-amber-900/10 border border-amber-900/20 rounded-lg p-4 mb-6 flex items-start'>
                ...
                <p className='text-muted-foreground text-left'>
                  ...
                  team. This process usually take 1-2 business days. You&apos;
                  receive an email notification once your account is reviewed.
                </p>
              </div>
            )}
            ...
            <p className='text-muted-foreground mb-6'>
              {isRejected
                ...
                : 'While you wait, you can familiarize yourself with our platform and reach out to our support teams if you have any questions'}
            </p>
